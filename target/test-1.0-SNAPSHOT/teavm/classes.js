...
var BT=$rt_throw;var Ck=$rt_compare;var Cl=$rt_nullCheck;var BV=$rt_cls;var Ce=$rt_createArray;var Cm=$rt_isInstance;var Cn=$rt_nativeThread;var Co=$rt_suspending;var Cp=$rt_resuming;var Cq=$rt_invalidPointer;var D=$rt_s;var BG=$rt_eraseClinit;var Cr=$rt_imul;var Cs=$rt_wrapException;var Ct=$rt_checkBounds;var Cu=$rt_checkUpperBound;var Cv=$rt_checkLowerBound;var Cw=$rt_wrapFunction0;var Cx=$rt_wrapFunction1;var Cy=$rt_wrapFunction2;var Cz=$rt_wrapFunction3;var CA=$rt_wrapFunction4;var C=$rt_classWithoutFields;var CB
...
var Bx=C();
function Ch(b){var c,d,e;BC();Bw();BJ();c=window.document;d=c.createElement("div");e=c.createTextNode("TeaVM generated element");d.appendChild(e);c.body.appendChild(d);}
var Ba=C(0);
var Br=C(0);
...
var C0=null;function Cd(a){var b=new O();BB(b,a);return b;}
function BB(a,b){var c,d,e,f;b=b.data;c=b.length;d=U(c);e=d.data;a.b=d;f=0;while(f<c){e[f]=b[f];f=f+1|0;}}
...
var Bu=C(0);
var Bb=C(R);
function Bl(a,b){var c,d,e,f,g,h,i;c=a.c;if(c>=0&&c<=c){a:{if(b===null)b=D(2);else if(b.b.data.length?0:1)break a;d=c+G(b)|0;e=a.a.data.length;if(e<d){f=e>=1073741823?2147483647:BA(d,BA(e*2|0,5));g=a.a.data;h=U(f);e=g.length;if(f<e)e=f;i=h.data;f=0;while(f<e){i[f]=g[f];f=f+1|0;}a.a=h;}d=a.c-1|0;while(d>=c){a.a.data[d+G(b)|0]=a.a.data[d];d=d+(-1)|0;}a.c=a.c+G(b)|0;f=0;while(f<G(b)){h=a.a.data;e=c+1|0;h[c]=V(b,f);f=f+1|0;c=e;}}return a;}BT(BY());}
var S=C();
var Bi=C(S);
...
var Bh=C();
var N=C();
var C5=null;var C6=null;function BJ(){C5=BV($rt_charcls());C6=Ce(N,128);}
var Z=C(X);
var BF=C(Z);
...
var BM=C();
$rt_packages([]);
$rt_metadata([B,0,0,[],0,3,0,0,0,Bx,0,B,[],0,3,0,0,0,Ba,0,B,[],3,3,0,0,0,Br,0,B,[],3,3,0,0,0,Bq,0,B,[Ba,Br],0,3,0,0,0,BN,0,B,[],4,0,0,0,0,BE,0,B,[],4,3,0,0,0,L,0,B,[],3,3,0,0,0,M,0,B,[],3,3,0,0,0,P,0,B,[],3,3,0,0,0,O,0,B,[L,M,P],0,3,0,0,0,J,0,B,[],0,3,0,0,0,Q,0,J,[],0,3,0,0,0,H,0,Q,[],0,3,0,0,0,BD,0,H,[],0,3,0,0,0,R,0,B,[L,P],0,0,0,0,0,Bu,0,B,[],3,3,0,0,0,Bb,0,R,[Bu],0,3,0,0,0,S,0,B,[L],1,3,0,0,0,Bi,0,S,[M],0,3,0,0,0,K,0,H,[],0,3,0,0,0,BK,0,K,[],0,3,0,0,0,BL,0,K,[],0,3,0,0,0,W,0,J,[],0,3,0,0,0,X,0,W,[],0,3,
0,0,0,I,0,B,[],3,3,0,0,0,Bg,0,B,[I],3,3,0,0,0,Bo,0,B,[Bg],3,3,0,0,0,F,0,B,[I],3,3,0,0,0,Bz,0,B,[Bo,F],3,3,0,0,0,BI,0,B,[],4,3,0,0,0,Bn,0,B,[F],3,3,0,0,0,Bj,0,B,[F],3,3,0,0,0,Bt,0,B,[F],3,3,0,0,0,Bc,0,B,[F],3,3,0,0,0,Bv,0,B,[F],3,3,0,0,0,Bd,0,B,[F,Bn,Bj,Bt,Bc,Bv],3,3,0,0,0,Bs,0,B,[],3,3,0,0,0,Bk,0,B,[I],3,3,0,0,0,BP,0,B,[I,Bd,Bs,Bk],1,3,0,0,["v",Cy(BX),"H",Cy(BQ),"I",Cx(B2),"y",Cz(B9),"p",Cx(BW),"C",Cw(BU),"z",Cz(BS)],Bp,0,B,[],3,3,0,0,0,Bh,0,B,[Bp],0,3,0,0,0,N,0,B,[M],0,3,0,0,0,Z,0,X,[],0,3,0,0,0,BF,0,Z,[],
